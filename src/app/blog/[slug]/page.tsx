  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      <div className="max-w-7xl mx-auto px-4 py-12">
        ...
        <div className="flex items-center justify-between mb-8 lg:max-w-none">
          <Link
            href="/blog"
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[auto_250px] gap-8">
          <div className="flex justify-end">
            <article className="lg:max-w-2xl 2xl:max-w-4xl">
              {/* Cover Image */}
              {frontmatter.image && (
