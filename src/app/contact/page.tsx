        ...
        <div className="grid md:grid-cols-2 gap-12">
          ...
          <div className="space-y-8">
            ...
            <section>
              ...
              <p className="text-gray-600 dark:text-gray-400 leading-relaxed mb-4">
                我对跨学科的合作特别感兴趣，尤其是那些能够将不同思维方式融合的项目。
              </p>
              <p className="text-gray-600 dark:text-gray-400 leading-relaxed">
                If you&apos;re working on something that bridges different
                domains of knowledge or explores new ways of thinking, I&apos;d
          ...
          <div className="space-y-8">
            ...
            <section>
              ...
              <p className="text-gray-600 dark:text-gray-400 leading-relaxed">
                I typically respond within 2-3 days. For urgent matters, please
                mention it in your subject line. I believe in giving thoughtful
                responses rather than quick replies.
              </p>
            </section>
